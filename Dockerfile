...
RUN curl -L -sS https://www.dropbox.com/s/azw32peu8edrioj/wisdomifier.mar?dl=1 > wisdomifier.mar
RUN mkdir ./model_storage
RUN mv ./wisdomifier.mar ./model_storage/wisdomifier.mar

#COPY ./nginx.conf /etc/nginx/nginx.conf
EXPOSE 8080 8081 8082
CMD ["torchserve" , "--start", "--model-store", "./model_storage", "--models", "wisdomifier.mar"]
